...
import com.example.coinviewer.databinding.FragmentPriceChangeBinding
import com.example.coinviewer.view.adapter.PriceListUpDownRVAdapter
...
class PriceChangeFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        viewModel.arr15mind.observe(viewLifecycleOwner, Observer {
        ...
        viewModel.arr30mind.observe(viewLifecycleOwner, Observer {
        ...
        viewModel.arr45mind.observe(viewLifecycleOwner, Observer {
