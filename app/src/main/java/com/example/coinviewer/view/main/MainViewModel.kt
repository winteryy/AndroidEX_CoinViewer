...
import com.example.coinviewer.dataModel.UpDownDataSet
...
class MainViewModel: ViewModel() {
    ...
    val arr15mind: LiveData<List<UpDownDataSet>>
        get() = _arr15min

    private val _arr30min = MutableLiveData<List<UpDownDataSet>>()
    val arr30mind: LiveData<List<UpDownDataSet>>
        get() = _arr30min

    private val _arr45min = MutableLiveData<List<UpDownDataSet>>()
    val arr45mind: LiveData<List<UpDownDataSet>>
        get() = _arr45min
